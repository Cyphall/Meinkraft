...
void Stone::genVertices(std::vector<VertexData>& vertices, glm::u8vec3 pos, BlockType xp1, BlockType xm1, BlockType yp1, BlockType ym1, BlockType zp1, BlockType zm1)
{
	if (xp1 == BlockType::TRANSPARENT)
	{
		...
		vertexBL.texture = BlockTextureId::STONE;
		vertexTL.texture = BlockTextureId::STONE;
		vertexBR.texture = BlockTextureId::STONE;
		vertexTR.texture = BlockTextureId::STONE;
